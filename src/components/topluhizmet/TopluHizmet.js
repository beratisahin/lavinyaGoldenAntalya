  ...
  handleChange(e) {
    ...
    this.setState({
      kampanyaAd: encodeURI(
        `https://wa.me/++905527394624?text=${e.target.value}`
      ),
    });
  }
      ...
      >
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <Taslak
            ...
            taslakphoto={m5}
            taslaktext="Antalya Lavinya Golden Güzellik Salonu olarak siz değerli müşterilerimize lazer epilasyon, cilt bakımı ve bölgesel incelme vb alanlarda hizmet vermekteyiz."
