            ...
            <div className="card m-4" style={{align:"center",backgroundColor:"#f8f7fb",borderRadius:"5px"}}>
              ...
              <div class="col-12">
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b1} className="d-block img-responsive blogPhoto" title="Antalya Lazer Epilasyon" alt="Antalya Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b2} className="d-block img-responsive blogPhoto" title="Antalya Lazer Epilasyon" alt="Antalya Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b3} className="d-block img-responsive blogPhoto" title="Antalya Lazer Epilasyon" alt="Antalya Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b4} className="d-block img-responsive blogPhoto" title="Antalya Lazer Epilasyon" alt="Antalya Lazer Epilasyon"></img>
                  <h4 className="blogTitle">Lazer Epilasyonda Başarıyı etkileyen faktörler nelerdir?</h4>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b5} className="d-block img-responsive blogPhoto" title="Antalya Lazer Epilasyon" alt="Antalya Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b6} className="d-block img-responsive blogPhoto" title="Antalya Lazer Epilasyon" alt="Antalya Lazer Epilasyon"></img>
